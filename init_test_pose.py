...
def get_args_parser():
    ...
    parser.add_argument("--model_path", type=str, default="/home/hu997372/code/sparse_recon/dust3r/checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth", help="path to the model weights")
    ...
    parser.add_argument("--llffhold", type=int, default=100)
