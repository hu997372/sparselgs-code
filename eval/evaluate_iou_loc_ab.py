...
if __name__ == "__main__":
    ...
    ae_ckpt_dir = '../autoencoder/ckpt/{}'.format(dataset_name)
    ae_ckpt_path = os.path.join(ae_ckpt_dir, "best_ckpt.pth")
    encoder_dims, decoder_dims = [256, 128, 64, 32, 3], [16, 32, 64, 128, 256, 256, 512]
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
